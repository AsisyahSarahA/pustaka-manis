...
@section('content')
    ...
    <div style="width: 85.6mm; height: 53.98mm; border: 1px solid #ddd; border-radius: 6px; overflow: hidden; background: linear-gradient(135deg, #162032 0%, #2A3B54 100%); color: #fff; display: flex; flex-direction: column;">
        <div style="padding: 4mm 5mm; flex: 1;">
            ...
            <div style="text-align: center; margin-top: 3px;">
                <img src="data:image/png;base64,{{ $barcode }}" alt="barcode" style="width: 60mm; height: auto;" />
                <div style="font-family: monospace; font-size: 7px; letter-spacing: 1px; margin-top: 1px; color: rgba(255,255,255,0.8);">
